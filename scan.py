#MR.R4M4 D4N1 FGS , SMK YP 17 SELOREJO
...
def main():
    ...
    print("  |CS   '--'     | ")
    print("{}  '--------------'----------{}------------------.  ").format(r,w)
    print("{}  | {}Author  : {}R4M4 D4N1 {}    | {}INDO{}N{}{}ESIA         | ").format(r,w,r,w,r,ir,reset,w)
    print("{}  | {}Youtube : {}Rama Dani     {}| {}+62-816-1578-8876 {}|").format(r,w,w,w,lgray,w)
    print("{}  '------------------------------------{}-------'  ").format(r,w)
